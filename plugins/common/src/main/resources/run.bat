...
if not exist "%THORNTAIL_CONFIG_LOCATION" (
  set THORNTAIL_CONFIG_LOCATION=%ROOT_DIR%\conf
) else (
  set THORNTAIL_CONFIG_LOCATION=%THORNTAIL_CONFIG_LOCATION%;%ROOT_DIR%\conf
)
