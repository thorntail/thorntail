...
public class ExpressionParserTest {
    ...
    public void testVariableNode() {
        ...
        assertThat(node.getVariableName()).isEqualTo("my.var");

        assertThat(node.getDefaultExpression()).isNull();
    }
    ...
    public void testVariableNodeWithVariableDefault() {
        ...
        assertThat(((VariableNode) defaultExpr.getNodes().get(0)).getVariableName()).isEqualTo("foo.bar");
    }
    ...
    public void testVariableNodeWithVariableDefaultWithLiteralDefault() {
        ...
        assertThat(((VariableNode) defaultExpr1.getNodes().get(1)).getVariableName()).isEqualTo("my.other.var");
    ...
    public void testVariableOnly() {
        ...
        assertThat(((VariableNode) expr.getNodes().get(0)).getVariableName()).isEqualTo("my.var");
    }
    ...
    public void testMixed1() {
        ...
        assertThat(((VariableNode) expr.getNodes().get(1)).getVariableName()).isEqualTo("my.var");
