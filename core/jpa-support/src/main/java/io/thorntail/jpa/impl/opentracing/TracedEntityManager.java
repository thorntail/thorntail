 ...
 */
public class TracedEntityManager implements EntityManager, TraceInfo {

    public TracedEntityManager(TraceMode traceMode, EntityManager delegate) {
    ...
    public Query createNamedQuery(String name) {
        return new TracedQuery(this, delegate.createNamedQuery(name));
    }

    @Override
    public <T> TypedQuery<T> createNamedQuery(String name, Class<T> resultClass) {
        return new TracedTypedQuery(this, name, resultClass, delegate.createNamedQuery(name, resultClass));
    }
