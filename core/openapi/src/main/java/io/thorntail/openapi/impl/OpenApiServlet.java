...
public class OpenApiServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (accept != null && formatParam != null && accept.contains(OpenApiSerializer.Format.JSON.getMimeType()) ||
    ...
    private String getModel(OpenApiSerializer.Format format) {
        try {
            ...
            throw OpenApiMessages.MESSAGES.unableToSerializeOpenApiModel(format, ioe);
        }
    }
