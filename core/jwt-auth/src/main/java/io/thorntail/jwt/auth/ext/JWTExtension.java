package io.thorntail.jwt.auth.ext;
...
import io.thorntail.jwt.auth.impl.ClaimProviderBeanAttributes;
import io.thorntail.jwt.auth.impl.RawClaimTypeProducer;
import io.thorntail.jwt.auth.impl.undertow.JWTAuthMechanism;
