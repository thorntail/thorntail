 ...
 */
package org.wildfly.swarm.spring.rest;
 ...
 * @author Ken Finnigan
 */
public class SpringRestConfiguration extends AbstractServerConfiguration<SpringRestFraction> {
    public SpringRestConfiguration() {
        super(SpringRestFraction.class);
    }

    @Override
    public SpringRestFraction defaultFraction() {
        return new SpringRestFraction();
    }
