...
/**
 * Sets up and tears down a set of contexts, represented by a list of {@link SetupAction}s.
 * If {@link #setup(java.util.Map)} completes successfully then {@link #teardown(java.util.Map)} must be called.
 *
...
final class ContextManager {
     ...
     */
    void teardown(final Map<String, Object> properties) {
