 ...
 */
public class TracedCallableStatement extends TracedPreparedStatement implements CallableStatement {

    public TracedCallableStatement(TracedConnection connection, String sql, CallableStatement delegate) {
        super( connection, sql, delegate );
    }
