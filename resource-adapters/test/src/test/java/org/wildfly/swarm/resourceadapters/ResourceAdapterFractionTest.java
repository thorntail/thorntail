...
public class ResourceAdapterFractionTest implements ContainerFactory {	
	    ...
	    public Container newContainer(String... args) throws Exception {
	        return new Container().fraction(new ResourceAdapterFraction().resourceAdapter("xadisk.rar", (ra) -> {
