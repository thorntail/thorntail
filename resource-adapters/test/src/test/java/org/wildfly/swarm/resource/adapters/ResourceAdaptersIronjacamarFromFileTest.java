...
public class ResourceAdaptersIronjacamarFromFileTest implements ContainerFactory {

    @Deployment(testable = false)
    public static Archive<?> createDeployment1() {
        final File ironJacamarXmlFile = new File("src/test/resources/ironjacamar.xml");
        ...
        deploymentRar.resourceAdapter(ironJacamarXmlFile);
