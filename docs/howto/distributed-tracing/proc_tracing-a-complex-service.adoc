...
The most important part is this usage of Eclipse MicroProfile OpenTracing API:
...
This snippet shows how Eclipse MicroProfile OpenTracing integrates with JAX-RS Client to ensure the trace is propagated across services.
