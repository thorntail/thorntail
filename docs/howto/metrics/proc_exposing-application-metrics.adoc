...
This is what the Eclipse MicroProfile Metrics specification requires, and also what Prometheus expects.
--
...
Here, the `@Counted` annotation is used to keep track of how many times this method was invoked.
...
There are other metrics, automatically exposed by {Thorntail} as the Eclipse MicroProfile Metrics specification requires.
