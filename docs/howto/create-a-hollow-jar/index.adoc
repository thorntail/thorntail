...
You can also execute the Maven binary with the system property `-Dthorntail.hollow=true` instead. For more information, see the xref:thorntail-maven-plugin-configuration-options_{context}[Maven plugin configuration reference].
--
