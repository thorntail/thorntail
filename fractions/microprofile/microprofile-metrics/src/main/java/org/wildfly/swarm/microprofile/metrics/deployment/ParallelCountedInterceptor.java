...
/* package-private */ class ParallelCountedInterceptor {
    ...
    private static final Logger LOGGER = Logger.getLogger(ParallelCountedInterceptor.class);
    ...
    @Inject
    private ParallelCountedInterceptor(@Intercepted Bean<?> bean, MetricRegistry registry) {
        this.bean = bean;
