...
public class TransactionsFraction extends Transactions<TransactionsFraction> implements Fraction<TransactionsFraction> {
    ...
    private Configurable<Integer> port = integer( "swarm.transactions.port", DEFAULT_PORT );
    private Configurable<Integer> statusPort = integer( "swarm.transactions.status.port", DEFAULT_STATUS_PORT );
}
