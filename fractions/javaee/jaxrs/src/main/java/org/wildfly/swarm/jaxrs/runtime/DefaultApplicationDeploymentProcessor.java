...
public class DefaultApplicationDeploymentProcessor implements DeploymentProcessor {
     ...
     */
    private static final ArchivePath PATH_WEB_XML = ArchivePaths.create(ArchivePaths.create("WEB-INF"), "web.xml");
    ...
    private void addGeneratedApplication(JAXRSArchive archive) {
        ...
        byte[] generatedApp;
        try {
            generatedApp = ApplicationFactory2.create(name, applicationPath.get());
