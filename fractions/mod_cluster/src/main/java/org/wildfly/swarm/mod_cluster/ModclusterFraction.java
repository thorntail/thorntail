...
public class ModclusterFraction extends Modcluster<ModclusterFraction> implements Fraction<ModclusterFraction> {
    ...
    private Configurable<String> multicastAddress = string("swarm.modcluster.multicast.address", "224.01.105");
    private Configurable<Integer> multicastPort = integer("swarm.modcluster.multicast.port", 23364);
