package org.jboss.unimbus.jwt.auth.ext;
...
import org.jboss.unimbus.jwt.auth.impl.ClaimProviderBeanAttributes;
import org.jboss.unimbus.jwt.auth.impl.RawClaimTypeProducer;
import org.jboss.unimbus.jwt.auth.impl.undertow.JWTAuthMechanism;
...
public class JWTExtension implements Extension {
    private static Logger log = Logger.getLogger(JWTExtension.class);
