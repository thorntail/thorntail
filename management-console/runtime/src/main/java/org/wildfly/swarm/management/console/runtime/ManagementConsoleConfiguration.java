...
public class ManagementConsoleConfiguration extends AbstractServerConfiguration<ManagementConsoleFraction> {
    ...
    public List<Archive> getImplicitDeployments(ManagementConsoleFraction fraction) throws Exception {
        // Get the management-console-ui bits as an Archive
        String gav = "org.wildfly.swarm:management-console-ui:war:" + ManagementConsoleFraction.VERSION;

        WARArchive war = ArtifactLookup.get().artifact(gav,"management-console-ui.war")
                .as(WARArchive.class)
