...
package org.jboss.unimbus.openapi.impl.api.models.responses;
...
public class APIResponsesImpl extends LinkedHashMap<String, APIResponse> implements APIResponses, ModelImpl {
    ...
    /**
     * @see APIResponses#addApiResponse(String, APIResponse)
     */
    @Override
    ...
    /**
     * @see APIResponses#setDefaultValue(APIResponse)
     */
    @Override
    ...
    /**
     * @see APIResponses#defaultValue(APIResponse)
     */
    @Override
