 ...
 */
package org.jboss.unimbus.openapi.impl.api;
...
import org.jboss.unimbus.openapi.impl.OpenApiMessages;
import org.jboss.unimbus.openapi.impl.OpenApiModel;
...
import org.jboss.unimbus.openapi.impl.api.util.FilterUtil;
import org.jboss.unimbus.openapi.impl.api.util.MergeUtil;
import org.jboss.unimbus.openapi.impl.api.util.ServersUtil;
...
public class OpenApiDocument {
    ...
    private OpenAPI filterModel(OpenAPI model) {
        ...
        try {
            Class<?> c = uNimbus.getClassLoader().loadClass(filterClassName.get());
