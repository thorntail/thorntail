...
public class MoreResourceLoaders {
    private MoreResourceLoaders() {}

    // needed until we have MODULES-223
    /**
     ...
     * @param relativePath the path to the resource root within the JAR
     * @return the resource loader
     */
    public static ResourceLoader createJarResourceLoader(final String name, final JarFile jarFile, final String relativePath) {
