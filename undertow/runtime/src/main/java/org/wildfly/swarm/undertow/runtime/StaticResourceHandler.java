...
public class StaticResourceHandler implements HttpHandler {
    ...
    /**
     * You should use {@link StaticResourceHandler(ResourceManager)} instead.
     */
    @Deprecated
    ...
    private void serveResource(final HttpServerExchange exchange, final boolean sendContent) throws Exception {
        ...
        HttpHandler dispatchTask = new HttpHandler() {
            ...
            public void handleRequest(HttpServerExchange exchange) throws Exception {
                ...
                final ContentEncodedResourceManager contentEncodedResourceManager = StaticResourceHandler.this.contentEncodedResourceManager;
    ...
    public StaticResourceHandler setDirectoryListingEnabled(final boolean directoryListingEnabled) {
    ...
    public StaticResourceHandler setMimeMappings(final MimeMappings mimeMappings) {
    ...
    public StaticResourceHandler setCachable(final Predicate cachable) {
    ...
    public StaticResourceHandler setAllowed(final Predicate allowed) {
    ...
    public StaticResourceHandler setResourceManager(final ResourceManager resourceManager) {
        this.resourceManager = resourceManager;
        return this;
    }
    ...
    public StaticResourceHandler setCacheTime(final Integer cacheTime) {
    ...
    public StaticResourceHandler setContentEncodedResourceManager(ContentEncodedResourceManager contentEncodedResourceManager) {
    ...
    private static class Wrapper implements HandlerWrapper {
        ...
        public HttpHandler wrap(HttpHandler handler) {
            ...
            StaticResourceHandler resourceHandler = new StaticResourceHandler(rm);
