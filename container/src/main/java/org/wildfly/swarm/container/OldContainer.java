...
public class OldContainer {
    ...
    public OldContainer subsystem(Fraction fraction) {
        this.fractions.add(fraction);
        return this;
    }

    public OldContainer iface(String name, String expression) {
        this.interfaces.add(new Interface(name, expression));
        return this;
    }

    public OldContainer socketBindingGroup(SocketBindingGroup group) {
        this.socketBindingGroups.add(group);
        return this;
    }

    public synchronized OldContainer start() throws Exception {
