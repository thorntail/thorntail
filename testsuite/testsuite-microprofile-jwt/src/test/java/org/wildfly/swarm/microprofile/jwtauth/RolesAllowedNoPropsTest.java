...
public class RolesAllowedNoPropsTest {
    ...
    public static Archive<?> createDeployment() throws Exception {
        ...
        deployment.addAsResource("project-no-roles-props.yml");
        URL url = RolesAllowedNoPropsTest.class.getResource("/publicKey.pem");
        deployment.addAsManifestResource(new UrlAsset(url), "/MP-JWT-SIGNER");
        return deployment;
    }
    @CreateSwarm
    public static Swarm newContainer() throws Exception {
        URL projectYml = RolesAllowedNoPropsTest.class.getResource("/project-no-roles-props.yml");
    ...
    private static PrivateKey getPrivateKey() throws Exception {
        InputStream is = RolesAllowedNoPropsTest.class.getResourceAsStream("/privateKey.pem");
