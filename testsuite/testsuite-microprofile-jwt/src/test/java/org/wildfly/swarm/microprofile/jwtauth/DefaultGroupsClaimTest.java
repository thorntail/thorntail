...
public class DefaultGroupsClaimTest {
    @Deployment
    public static Archive<?> createDeployment() {
        return initDeployment().addAsResource("project-default-groups.yml", "project-defaults.yml");
    }
    ...
    @RunAsClient
    @Test
    public void defaultGroupsClaim() throws Exception {
        String response = Request.Get("http://localhost:8080/mpjwt/default-group/secured")
                .setHeader("Authorization", "Bearer " + createToken(null))
