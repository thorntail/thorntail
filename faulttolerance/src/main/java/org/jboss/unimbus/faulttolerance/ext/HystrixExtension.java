 ...
 */
package org.jboss.unimbus.faulttolerance.ext;
...
import org.jboss.unimbus.faulttolerance.impl.hystrix.HystrixCommandBinding;
...
public class HystrixExtension implements Extension {
     ...
     * @param event
     */
    private void collectFaultToleranceOperations(@Observes ProcessManagedBean<?> event) {
    ...
    public FaultToleranceOperation getFaultToleranceOperation(String methodKey) {
