 ...
 */
package org.jboss.unimbus.faulttolerance.impl.config;
...
public class CircuitBreakerConfig extends GenericConfig<CircuitBreaker> {
    ...
    public void validate() {
        ...
        if (!getConfig().getOptionalValue(FaultToleranceConstants.SYNC_CIRCUIT_BREAKER_KEY, Boolean.class).orElse(true) && successThreshold > 1) {
